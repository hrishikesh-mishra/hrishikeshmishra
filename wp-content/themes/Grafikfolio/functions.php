...
<h3>How to display big images for Featured Slider</h3>
<p>Go to menu below, check the box to activate featured content slider in homepage. Choose a category from which featured posts are drawn.</p>
<p>Edit your post, add new Custom Field. Name = slider, Value = the image URL. Each image will be cropped to sizes 960 x 360 px. You should host those images in your domain.</p>
